...
public class DefaultMethodsTest {
  ...
  public void testRuntimeModelClassForRule()
    ...
    IRule<?> rule = Class.forName("com.ebay.rtran.mock.MockRule").asSubclass(IRule.class).newInstance();
  ...
  public void testRutimeModelClassAndRuntimeProjectClassForModelProvider()
      throws IllegalAccessException, ClassNotFoundException, InstantiationException {
    IModelProvider<?, ?> provider = Class.forName("com.ebay.rtran.mock.MockModelProvider")
